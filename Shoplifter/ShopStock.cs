...
{	
	public class ShopStock
	{
		...
		{           
			...
			Random random = new Random((int)Game1.uniqueIDForThisGame / 2 + (int)Game1.stats.DaysPlayed + ModEntry.PerScreenShopliftCounter.Value - (int)Game1.player.UniqueMultiplayerID);
